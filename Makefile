...
build-test-image:
	docker build . -f DockerfileForUnitTesting -t registry.tozny.com/tozny/tozny-test/e3dbclientsgo-test:local
	# docker build . -f DockerfileForUnitTesting -t e3dbclientsgo-test:$(TEST_IMAGE_TAG)
...
publish-test-image: build-test-image
	...
	docker tag registry.tozny.com/tozny/tozny-test/e3dbclientsgo-test:local registry.tozny.com/tozny/tozny-test/e3dbclientsgo-test:$(TEST_IMAGE_TAG)
	docker push registry.tozny.com/tozny/tozny-test/e3dbclientsgo-test:$(TEST_IMAGE_TAG)